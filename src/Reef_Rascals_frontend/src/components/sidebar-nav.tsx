import styles from '../scss/components/sidebar-nav.module.scss';
...
export default function SidebarNav() {
    ...
    return (
        <div id="sidebar-container" className={styles.sidebarContainer} onMouseOver={toggleSidebar}
             onMouseOut={toggleSidebar}>
            <a onClick={()=>{
                handleChangeRoute("/" + canisterId)
            }}>
            ...
            <a onClick={()=>{
                ...
                <span className={styles.iconText}>Marketplace</span>
                    ...
                    <a onClick={()=>{
                        ...
                        <span className={styles.iconText}>Aquarium</span>
                    </a>
                    <a onClick={()=>{
                        handleChangeRoute("/profile/" + authContext.principal + "/" + canisterId)
                    }}>
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path
                            fill="currentColor" fillRule="evenodd"
